...
![Screen recording of invisible ink text effect in iMessage, then revealing the text "But it does!!!"](imessage-spoiler-text-effect.gif)
...
![Screenshot of how to select Invisible Ink in iMessage "Send with Effect" screen. The option is highlighted with a red box next to the sample message "Dumbledore is Snape's father"](send-with-effect.jpg)
